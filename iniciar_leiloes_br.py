...
# -*- coding: utf-8 -*-
"""
Script para iniciar scraping do LeilõesBR via API
"""
...
def iniciar_leiloes_br(max_paginas=None, delay=1.0, max_retries=3):
    """Inicia o scraping do LeilõesBR"""
    url = "http://localhost:8000/api/v1/leiloes-br"
    ...
    try:
        print(">>> Iniciando scraping do LeiloesBR...")
        ...
        if response.status_code == 200:
            ...
            print("   - Frontend: http://localhost:3000/leiloes-br")
...
if __name__ == "__main__":
    ...
    session_id = iniciar_leiloes_br(max_paginas=max_paginas)
